    ...
    <div class="section">
        ...
        <form class="form_container col-lg-6" action="login.php" method="POST">
            ...
            <div class="input_container">
                ...
                <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon-login">
            ...
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="input-passowrd" type="password" class="input_field" id="password_field">
            </div>
            <button title="Sign In" type="submit" name="submit_login"class="sign-in_btn">
                <span>Sign In</span>
            </button>
