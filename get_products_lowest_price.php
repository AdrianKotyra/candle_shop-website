...
<?php 
    ...
    $getQuery = "SELECT * FROM products ORDER BY product_price ASC LIMIT " . $initial_page . ", " . $limit_products;
...
for($page_number = 1; $page_number<= $total_pages; $page_number++) { 
    ...
    if(intval($_GET["page"])===intval($page_number)) {
        ...
        echo "<a class='$active_paggination pagination-link' href = 'products.php?products=lowest_price&page=" . $page_number . "'> <p>" . $page_number . " </p> </a>";  
    }
    else {
       
        $active_paggination = "pagination-link";
   
        echo "<a class='$active_paggination' href = 'products.php?products=lowest_price&page=" . $page_number . "'> <p>" . $page_number . " </p> </a>";  
    }
