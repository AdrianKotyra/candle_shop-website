    ...
    <div class="products_section_products">
                ...
                <label>
                    <input class="radio-input" type="radio" name="engine">
                        <span class="radio-tile">
                            ...
                            <span class="radio-label">Highest price</span>
                        </span>
                </label>
                <label>
                    ...
                    <span class="radio-tile">
                        ...
                        <span class="radio-label">Lowest price</span>
                    </span>
                </label>
                <label>
                    <input class="radio-input" type="radio" name="engine">
                    <span class="radio-tile">
                        ...
                        <span class="radio-label">Alphabetical</span>
                    </span>
                </label>
            </div>
        </div>
        ...
        <div class="products_container_products">
            ...
            <div class="row no-gutters no-pad products_row_products">
                ...
                <?php display_all_products_in_grid_pagination("products.php")?>
